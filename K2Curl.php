...
class K2_CURL {
    ...
    private $__url        = "";
    private $__curl       = "";
    private $__curlData   = array();
    private $__curlMethod = "";
    private $__curlResult = "";
    private $__curlHeader = array(
        'Cache-Control: no-cache',
        'Content-Type: application/x-www-form-urlencoded; charset=utf-8',
    );
    private $__curlError  = "";
    private $__time_taken = "";
     ...
     * @return void
     */
    public function set_userAgent($userAgent = 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:60.0) Gecko/20100101 Firefox/60.0') {
        if (SELF::DEBUG) {
